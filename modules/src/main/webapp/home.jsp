...
<body>
  ...
  <section id="title">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
      <a class="navbar-brand" href="">GRS</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
              <a class="nav-link" href="#pricing">InnuDecideAgilla</a>
          </li>
          <li class="nav-item">
    ...
    <div class="col-lg-6">
      <div class="head1">
      <h1 class="big-heading">Lorem ipsum dolor sit amet consectetur, adipisicing elit.</h1>
      <!-- <button type="button" class="btn btn-dark btn-lg download-button"><i class="fab fa-apple"></i>Download</button>
      <button type="button" class="btn btn-light btn-outline-light btn-lg download-button"><i class="fab fa-google-play"></i>Download</button> -->
    </div>
    </div>
    <div class="col-lg-6">
  ...
  <footer id="footer">
    ...
    <p>© Copyright 2022 Gavirangaswamy</p>
